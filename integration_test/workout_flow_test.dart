...
import '../test/support/fakes/fake_workout_location_data_source.dart';
import '../test/support/fakes/in_memory_auth_repository.dart';
import '../test/support/fakes/in_memory_workout_repository.dart';
...
void main() {
  ...
  testWidgets('completes the workout flow from dashboard to saved result', (
    tester,
  ) async {
    ...
    await tester.tap(find.byKey(AppKeys.dashboardStartWorkoutButton));
    await tester.pumpAndSettle();
